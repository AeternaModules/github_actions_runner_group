output "actions_runner_groups_id" {
  ...
  value       = { for k, v in github_actions_runner_group.actions_runner_groups : k => v.id }
}
output "actions_runner_groups_allows_public_repositories" {
  ...
  value       = { for k, v in github_actions_runner_group.actions_runner_groups : k => v.allows_public_repositories }
}
output "actions_runner_groups_default" {
  ...
  value       = { for k, v in github_actions_runner_group.actions_runner_groups : k => v.default }
}
output "actions_runner_groups_etag" {
  ...
  value       = { for k, v in github_actions_runner_group.actions_runner_groups : k => v.etag }
}
output "actions_runner_groups_inherited" {
  ...
  value       = { for k, v in github_actions_runner_group.actions_runner_groups : k => v.inherited }
}
output "actions_runner_groups_name" {
  ...
  value       = { for k, v in github_actions_runner_group.actions_runner_groups : k => v.name }
}
output "actions_runner_groups_restricted_to_workflows" {
  ...
  value       = { for k, v in github_actions_runner_group.actions_runner_groups : k => v.restricted_to_workflows }
}
output "actions_runner_groups_runners_url" {
  ...
  value       = { for k, v in github_actions_runner_group.actions_runner_groups : k => v.runners_url }
}
output "actions_runner_groups_selected_repositories_url" {
  ...
  value       = { for k, v in github_actions_runner_group.actions_runner_groups : k => v.selected_repositories_url }
}
output "actions_runner_groups_selected_repository_ids" {
  ...
  value       = { for k, v in github_actions_runner_group.actions_runner_groups : k => v.selected_repository_ids }
}
output "actions_runner_groups_selected_workflows" {
  ...
  value       = { for k, v in github_actions_runner_group.actions_runner_groups : k => v.selected_workflows }
}
output "actions_runner_groups_visibility" {
  ...
  value       = { for k, v in github_actions_runner_group.actions_runner_groups : k => v.visibility }
}
